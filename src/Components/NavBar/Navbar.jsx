...
function Navbar() {
  ...
  return (
    <>
      <section className="px-8 bg-[#0a192f] text-white fixed w-full z-[999]">
        <nav className="grid grid-cols-12 py-4">
          ...
          >
            <ul
              ...
              className={`font-semibold,pt-10 md:pt-0 text-center text-lg md:grid-cols-6 ${
                isOpen ? "md:grid" : "hidden"
              } md:grid`}
            >
              <Link to="/">
