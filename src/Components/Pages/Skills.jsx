...
function Skills() {
  return (
    <div>
      <h1 className="text-center text-[orange] text-3xl pt-2 pb-8">
        My Skills
      </h1>
        ...
        <div className="flex flex-wrap md:block">
          <div className="flex justify-between flex-wrap gap-5">
            <div className="flex-1 min-w-[350px]">
              <h1 className="text-center text-2xl pb-2 text-white">
                Languages
              </h1>
          ...
          <div className="flex justify-center md:justify-between pt-2 gap-5 flex-wrap max-w-[725px]">
